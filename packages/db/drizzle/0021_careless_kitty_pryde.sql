...
CREATE UNIQUE INDEX "github_imports_org_operation_key_idx" ON "github_imports" USING btree ("organization_id","operation_key");--> statement-breakpoint
...
CREATE INDEX "agent_events_org_project_occurred_at_idx" ON "agent_events" USING btree ("organization_id","project_id","occurred_at" DESC NULLS LAST);--> statement-breakpoint
