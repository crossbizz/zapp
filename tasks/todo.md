...
- [ ] V-3 Verify all 22 P0 exit criteria (PRD §39) with evidence links *(matrix is structurally green: 16 verified, 5 candidates, 1 V-2-blocked, 0 failed; E1 has one mocked browser journey plus separate workflow coverage, E8 has exact action/output bindings, and integrated cross-client/live-provider evidence is still required)*
