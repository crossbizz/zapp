...
- [ ] V-3 Verify all 22 P0 exit criteria (PRD §39) with evidence links *(matrix is structurally green: 18 verified, 3 live-provider candidates, 1 V-2-blocked, 0 failed; Stytch, GitHub, and database-provider evidence is still required)*
