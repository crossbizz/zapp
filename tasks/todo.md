...
- [x] MAC-5.5-FIX-1 Hybrid harness composition and offline catalog isolation
- [x] MAC-5.5-FIX-2 Align local-agent edit fixture with contained tools
...
- [x] MAC-6-FIX-5 Reconcile the hybrid corpus with the contained runtime contract
...
- [x] WEB-14-FIX-2 Integrated unified-builder E1 proof
...
- [x] MAC-8-FIX-2 Cross-client builder projection contract
...
- [x] WEB-18-FIX-15 Lovable surface hierarchy and More navigation parity
...
- [x] WEB-19-FIX-1 Restore persisted preview lifecycle after conversation reload
- [x] WEB-20 Project-card deletion lifecycle
- [x] WEB-21 Lovable-parity tabbed code editor
...
- [x] GATE-8 Scope Storybook Jest discovery to `@zapp/ui`
