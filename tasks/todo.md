...
- [ ] V-3 Verify all 22 P0 exit criteria (PRD §39) with evidence links *(matrix is structurally green: 17 verified, 4 candidates, 1 V-2-blocked, 0 failed; E1/E8 have exact browser/action output bindings, while cross-client sync and live-provider evidence are still required)*
