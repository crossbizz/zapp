...
- 2026-08-04 AR-1 architecture gate — The accepted ADR-0005 migration exception is mechanically bounded by a repo-wide default-deny gate to seven inherited desktop production paths and exact `df81175` import/call/use inventory equality; AR-1 and its tracker remain unchecked.
