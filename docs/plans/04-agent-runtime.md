...
- 2026-08-10 AR-19 CI remediation — Authoritative Linux exhausted the cancellation test's 30-second whole-fixture wrapper while starting an in-memory Temporal server and worker under monorepo contention; the clean-CI wrapper is now 60 seconds while the binding post-signal cancellation assertion remains strictly below five seconds, and the provider acceptance was not repeated.
