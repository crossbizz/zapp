...
- 2026-08-11 OPS-12-start CI fix — Built the workspace-runtime type dependency before the permanent suite's clean-checkout typecheck after exact-SHA Security exposed the stale-local-dist gap; the workflow ordering now has a regression assertion.
